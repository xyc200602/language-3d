...
请提供一个替代步骤来完成这个目标。只输出一个 JSON 对象，包含 description、expected_tools、verification 字段。"""
    ...
    # NOTE: create_dag_plan + _parse_dag_response removed (dead code —
    # 0 callers in src/ or tests/; flat + hierarchical planners are the
    # production paths). TaskDAG class itself is retained.
