...
_register(AssemblyTemplate(
    ...
    parts=[
        ...
        TemplatePartSpec("shoulder_servo_bracket", "structural", "肩部舵机支架", "PLA",
        ...
        TemplatePartSpec("elbow_servo_bracket", "structural", "肘部舵机支架", "PLA",
                         {"length": 50, "width": 45, "height": 35},
                         part_catalog_id="servo_mg996r"),
        TemplatePartSpec("forearm_link", "structural", "前臂连杆", "PLA",
                         {"length": 130, "width": 35, "height": 25}),
        TemplatePartSpec("wrist_servo_bracket", "structural", "腕部舵机支架", "PLA",
                         {"length": 40, "width": 35, "height": 30},
                         part_catalog_id="servo_mg996r"),
        TemplatePartSpec("wrist_rotate_joint", "joint", "腕部旋转关节", "PLA",
                         {"outer_diameter": 35, "height": 20, "shaft_diameter": 6},
                         part_catalog_id="servo_mg996r"),
        ...
        TemplatePartSpec("gripper_finger_left", "structural", "夹爪左手指", "PLA",
                         {"length": 35, "width": 8, "height": 15}),
        TemplatePartSpec("gripper_finger_right", "structural", "夹爪右手指", "PLA",
                         {"length": 35, "width": 8, "height": 15}),
    ],
    joints=[
        TemplateJointSpec("revolute", "base_plate", "shoulder_servo_bracket",
                          (-180, 180), axis="z"),
        TemplateJointSpec("revolute", "shoulder_servo_bracket", "upper_arm_link",
                          (-90, 90), axis="y"),
        TemplateJointSpec("revolute", "upper_arm_link", "elbow_servo_bracket",
                          (-135, 135), axis="y"),
        TemplateJointSpec("fixed", "elbow_servo_bracket", "forearm_link"),
        TemplateJointSpec("revolute", "forearm_link", "wrist_servo_bracket",
                          (-90, 90), axis="y"),
        TemplateJointSpec("revolute", "wrist_servo_bracket", "wrist_rotate_joint",
                          (-180, 180), axis="z"),
        TemplateJointSpec("fixed", "wrist_rotate_joint", "gripper_base"),
        TemplateJointSpec("fixed", "gripper_base", "gripper_finger_left"),
        TemplateJointSpec("fixed", "gripper_base", "gripper_finger_right"),
    ],
    default_angles={
        "shoulder_servo_bracket": 0.0,
        "upper_arm_link": 0.0,
        "elbow_servo_bracket": 0.0,
        "wrist_servo_bracket": 0.0,
        "wrist_rotate_joint": 0.0,
    },
))
...
_register(AssemblyTemplate(
    ...
    joints=[
        ...
        TemplateJointSpec("fixed", "chassis_plate", "motor_rr",
                          connection_method="bolted"),
        TemplateJointSpec("revolute", "motor_fl", "wheel_fl",
                          connection_method="press_fit"),
        TemplateJointSpec("revolute", "motor_fr", "wheel_fr",
                          connection_method="press_fit"),
        TemplateJointSpec("revolute", "motor_rl", "wheel_rl",
                          connection_method="press_fit"),
        TemplateJointSpec("revolute", "motor_rr", "wheel_rr",
                          connection_method="press_fit"),
...
_register(AssemblyTemplate(
    ...
    joints=[
        ...
        TemplateJointSpec("fixed", "chassis_frame", "motor_rr",
                          connection_method="bolted"),
        TemplateJointSpec("revolute", "motor_fl", "mecanum_fl",
                          connection_method="press_fit"),
        TemplateJointSpec("revolute", "motor_fr", "mecanum_fr",
                          connection_method="press_fit"),
        TemplateJointSpec("revolute", "motor_rl", "mecanum_rl",
                          connection_method="press_fit"),
        TemplateJointSpec("revolute", "motor_rr", "mecanum_rr",
                          connection_method="press_fit"),
